...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("Jack Wesley", "jack@wesley.com.br");
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_pagamento_do_pedido_seus_status_deve_ser_aguardando_entrega()
        {
             var order = new Order(_customer, 0, null);
        ...
        {
            var discount = new Discount(10, DateTime.Now.AddDays(-9));
